...
class Menu_radit extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('menu/index_radit', $data);
    ...
    public function submenu()
    {
        ...
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
        $this->load->model('Menu_model_radit', 'menu');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar_radit', $data);
            $this->load->view('templates/topbar_radit', $data);
            $this->load->view('menu/submenu_radit', $data);
            $this->load->view('templates/footer_radit');
        } else {
            $data = [
