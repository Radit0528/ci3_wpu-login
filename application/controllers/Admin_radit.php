...
class Admin_radit extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/index_radit', $data);
    ...
    public function role()
    {
        ...
        $this->load->view('templates/sidebar_radit', $data);
        $this->load->view('templates/topbar_radit', $data);
        $this->load->view('admin/role_radit', $data);
        $this->load->view('templates/footer_radit');
    }
    ...
    public function roleAccess($role_id)
    {
        ...
        $this->load->view('templates/sidebar_radit', $data);
        $this->load->view('templates/topbar_radit', $data);
        $this->load->view('admin/role-access_radit', $data);
        $this->load->view('templates/footer_radit');
    }
